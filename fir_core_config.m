...
function fir_core_config(this_block)
  ...
  this_block.setEntityName('fir_core');
  ...
  q0_port.setType('Fix_18_17');
  q1_port = this_block.port('q1');
  q1_port.setType('Fix_18_17');
  q10_port = this_block.port('q10');
  q10_port.setType('Fix_18_17');
  q11_port = this_block.port('q11');
  q11_port.setType('Fix_18_17');
  q12_port = this_block.port('q12');
  q12_port.setType('Fix_18_17');
  q13_port = this_block.port('q13');
  q13_port.setType('Fix_18_17');
  q14_port = this_block.port('q14');
  q14_port.setType('Fix_18_17');
  q15_port = this_block.port('q15');
  q15_port.setType('Fix_18_17');
  q2_port = this_block.port('q2');
  q2_port.setType('Fix_18_17');
  q3_port = this_block.port('q3');
  q3_port.setType('Fix_18_17');
  q4_port = this_block.port('q4');
  q4_port.setType('Fix_18_17');
  q5_port = this_block.port('q5');
  q5_port.setType('Fix_18_17');
  q6_port = this_block.port('q6');
  q6_port.setType('Fix_18_17');
  q7_port = this_block.port('q7');
  q7_port.setType('Fix_18_17');
  q8_port = this_block.port('q8');
  q8_port.setType('Fix_18_17');
  q9_port = this_block.port('q9');
  q9_port.setType('Fix_18_17');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('fir_core.vhd');
